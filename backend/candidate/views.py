...
class Canidate_registerview(APIView):
    ...
    def get(self, request):
        ...
        candidate = Canidate_register.objects.all()
        # Serialize the queryset of JobOpening objects
        serializer = Canidate_serializer(candidate, many=True)
...
class CanidateLogout(APIView):
    def post(self, request):
        if 'canidate_id' in request.session:
